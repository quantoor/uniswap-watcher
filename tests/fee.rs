...
async fn gas_fee_usdt() {
    let hash1 = "0xe55abfa818e6237b794a41a99482ef7108ed7d6c89867ed9b443011c93d2fb77".to_string();
    let hash2 = "0x465a5e24ebe4ad90d1a235455f14a12b4aba4b956893d4bf11d0d986ee42c4a7".to_string();
    let hash3 = "0x926484f31f9d99d24b0e984a98483f6459872fbcb7e0abd5f1ce704d70835cee".to_string();
    let app = Application::new().unwrap();
    let actual = app
        .get_tx_fee_batch(vec![hash1.clone(), hash2.clone(), hash3.clone()])
        .await
        .unwrap();
    let expected = HashMap::from([
        (hash1, 61.875928038562485),
        (hash2, 64.23295474697701),
        (hash3, 409.30215911746706),
    ]);
